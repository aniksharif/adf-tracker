...
esmConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/mjs/adf-conversion.mjs',
    format: 'esm'
});
...
esmProdConfig.output = Object.assign({}, esmConfig.output, {
    file: 'dist/mjs/adf-conversion.min.mjs',
    sourcemap: false
});
...
umdConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/umd/adf-conversion.js',
    format: 'umd'
});
umdConfig.plugins = [
...
umdProdConfig.output = Object.assign({}, umdConfig.output, {
    file: 'dist/umd/adf-conversion.min.js',
    sourcemap: false
});
...
if (process.env.SERVE) {
    ...
    serveConfig.output = Object.assign({}, commonConfig.output, {
        file: 'dist/render/adf-conversion.iife.js',
        format: 'iife'
    });
    serveConfig.plugins = [
        eslint({
